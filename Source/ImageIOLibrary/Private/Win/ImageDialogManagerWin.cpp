...
bool ImageDialogManagerWin::OpenFileDial(const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, bool MultipleFiles, TArray<FString>& OutFilenames)
{
    #if PLATFORM_WINDOWS
	int32 dummy = 0;
	return FileDialShared(false, ParentWindowHandle, DialogTitle, DefaultPath, DefaultFile, FileTypes, MultipleFiles, OutFilenames, dummy);
#endif
    return false;
}

bool ImageDialogManagerWin::SaveFileDial(const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, bool MultipleFiles, TArray<FString>& OutFilenames)
{
    #if PLATFORM_WINDOWS
	int32 dummy = 0;
	return FileDialShared(true, ParentWindowHandle, DialogTitle, DefaultPath, DefaultFile, FileTypes, MultipleFiles, OutFilenames, dummy);
#endif
    return false;
}

bool ImageDialogManagerWin::FileDialShared(bool isSaveFileDialog, const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, bool MultipleFiles, TArray<FString>& OutFilenames, int32& OutFilterIndex)
{
	bool bSuccess = false;
